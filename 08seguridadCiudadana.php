            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <div class="miga-de-pan">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Seguridad Ciudadana</li>
                        </ol>
                    </div>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Nuevas cámaras de vigilancia</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Vigilancia ciudadana. Sistema de cooperación ciudadana</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">App para presentar denuncios</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Desmantelamiento de expendios de droga</h4>
