            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Los nuevos semáforos inteligentes que mejorarán la movilidad en el centro de Bogotá</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Alcaldía apoya la construcción del primer Vehículo Eléctrico Autónomo hecho en colombia por el ingeniero Luis Fernando Pinillos Gómez</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">La movilidad en bicicleta para hacer turismo</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Secretaría de transporte</a>
                        <a href="#" class="list-group-item">Veeduría de las obras en vías</a>
                        ...
                        <a href="#" class="list-group-item">Decretos de movilidad</a>
                    </div>
                    <h4>Artículos recientes</h4>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Inicia proyecto</h4>
                        <p class="list-group-item-text">Comienzan las obras del metro</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Conozca las restricciones de movilidad en el centro</h4>
                        <p class="list-group-item-text">Zonas donde opera la restricción</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Rutas de buses, SIPT y Transmilenio</h4>
                        <p class="list-group-item-text">Rutas, horarios, paraderos</p>
                    </a>
                </aside>
