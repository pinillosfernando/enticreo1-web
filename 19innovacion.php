            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <div class="miga-de-pan">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Innovación</li>
                        </ol>
                    </div>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">EnTICreo. La plataforma web de las comunidades</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Vehículos autónomos en la ciudad</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Sistema digital de seguimiento de estudiantes en los colegios de la localidad</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Soluciones informáticas para los colegios</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Relación Universidad - Industria - Sociedad. Innovación y transferencia de tecnologías</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">App de Tecnosoft en la localidad de La Candelaria</h4>
