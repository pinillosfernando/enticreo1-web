            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Historia de la localidad en mapas</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Lugares de interés público</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Secretaría del Espacio Público</a>
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Mapas digitales de los servicios públicos</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Mapas y album fotográfico de la localidad</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Vectores de variables sociales</h4>
