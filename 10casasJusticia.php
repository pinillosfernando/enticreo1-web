            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <div class="miga-de-pan">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Casas de Justicia</li>
                        </ol>
                    </div>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">La justicia como valor de vida</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Secretaría de Justicia</a>
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Descongestión de juzgados</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Centros de conciliación</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Consultorios jurídicos de las Universidades</h4>
