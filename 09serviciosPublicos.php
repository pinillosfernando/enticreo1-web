            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">CADE en el centro de la ciudad</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Pago electrónico de los servicios públicos</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Sistema automático de gestión de quejas por servicios públicos</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Sistema automático de gestión de quejas</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Ahorremos agua y energía</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Calidad de los servicios públicos</h4>
