            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Programa de atención de los habitantes de la calle</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Vendedores ambulantes</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">La séptima: espacio ciudadano para el trabajo social</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Secretaría de Integración Social</a>
                        <a href="#" class="list-group-item">Veeduría de los programas sociales</a>
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Reubicación de desplazados</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Integración</h4>
                        <p class="list-group-item-text">Reunión de líderes sociales del la localidad</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Censo</h4>
                        <p class="list-group-item-text">Estudio de vulnerabilidad de habitantes de la ladera</p>
                    </a>
                </aside>
