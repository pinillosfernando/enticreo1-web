            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <div class="miga-de-pan">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Gastronomía</li>
                        </ol>
                    </div>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Conozca la comida bogotana</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">El ajiaco. Un plato internacional</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Libro de la comida bogotana</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Concurso de gastronomía de la localidad</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Inspección de oferta gastronómica</h4>
