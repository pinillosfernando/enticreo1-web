        <section class="main container">
            <div class="row"> 
                    ...
                    <div id="carouselSAB" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src=<?php echo $Imagen1Agrupacion;?> height="200" alt="Primero">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src=<?php echo $Imagen2Agrupacion;?> height="200" alt="Segundo">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src=<?php echo $Imagen3Agrupacion;?>  height="200" alt="Tercero">
                            </div>
                        </div>
                ...
                <section class="post col-md-3 hidden-xs hidden-sm">
                    <img class="d-block w-100" src=<?php echo $LogoAgrupacion;?> height="200" alt="Primero">
                </section>
            </div>
        </section>
