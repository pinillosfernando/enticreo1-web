            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <div class="miga-de-pan">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Cundinamarca</li>
                        </ol>
                    </div>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Cundinamarca</a>
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Proyectos de la región</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Representates</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Convenios de cooperación</h4>
