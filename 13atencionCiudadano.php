            ...
            <div class="row">
                <section class="post col-md-9">
                    ...
                    <div class="miga-de-pan">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Atención al Ciudadano</li>
                        </ol>
                    </div>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">Instructivo para atención online</a>
                        </h2>
                    ...
                    <article class="post clearfix">
                        ...
                        <h2 class="post-tittle">
                            <a href="#">¿Qué es un derecho de petición y como hacerlo?</a>
                        </h2>
                ...
                <aside class="post col-md-3 hidden-xs hidden-sm">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Atención al ciudadano</a>
                    ...
                    <a href="#" class="list-group-item">
                        ...
                        <p class="list-group-item-text">Derechos de petición online</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Comunidad</h4>
                        <p class="list-group-item-text">Conozca el programa de charlas con la comunidad de la Alcaldía Local y sus representantes de gobierno</p>
                    </a>
                    <a href="#" class="list-group-item">
                        <h4 class="list-group-item-heading">Casos especiales de adultos mayores</h4>
